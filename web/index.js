...
(function() {
 ...
 var loadPackage = function(metadata) {
  function runWithFS() {
   ...
   do {
    var name_addr = SAFE_HEAP_LOAD(start32++ * 4, 4, 1);
    var len = SAFE_HEAP_LOAD(start32++ * 4, 4, 1);
    var content = SAFE_HEAP_LOAD(start32++ * 4, 4, 1);
    var name = UTF8ToString(name_addr);
    Module["FS_createDataFile"](name, null, HEAP8.subarray(content, content + len), true, true, true);
   } while (SAFE_HEAP_LOAD(start32 * 4, 4, 1));
  }
  if (Module["calledRun"]) {
   runWithFS();
  } else {
...
var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 26932;
